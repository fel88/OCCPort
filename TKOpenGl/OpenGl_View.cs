...
global using Graphic3d_Vec3i = TKernel.NCollection_Vec3<int>;
global using Graphic3d_Vec4 = TKernel.NCollection_Vec4<float>;
global using Graphic3d_Vec4d = TKernel.NCollection_Vec4<double>;
global using Graphic3d_Mat4d = TKernel.NCollection_Mat4<double>;
global using Graphic3d_Mat4 = TKernel.NCollection_Mat4<float>;
global using OpenGl_ColorFormats = TKernel.NCollection_Vector<int>;
global using OpenGl_TextureArray = TKernel.NCollection_Vector<OCCPort.OpenGl_Texture>;
global using Aspect_RenderingContext = nint;
global using Aspect_Display = nint; /* Display* under UNIX */
global using GLint = int;
global using GLenum = uint;
global using GLbitfield = uint;

global using Graphic3d_Vec2d = TKernel.NCollection_Vec2<double>;
...
&& theParentVIew != null)
        ...
        public void renderStructs(Projection theProjection,
        ...
        private void raytrace(double v1, double v2, Projection theProjection, OpenGl_FrameBuffer theReadDrawFbo, OpenGl_Context aCtx)
        {
            throw new NotImplementedException();
        }
        ...
        void redraw(Projection theProjection,
                          OpenGl_FrameBuffer theReadDrawFbo,
                          OpenGl_FrameBuffer theOitAccumFbo)
        {
            OpenGl_Context aCtx = myWorkspace.GetGlContext();
        ...
        public override void Redraw()
        {
            ...
            Projection aProjectType = myCamera.ProjectionType();
          ...
          && (!IsActiveXR() || myRenderParams.ToMirrorComposer);
            ...
            if (aProjectType == Projection.Projection_Stereo)
            {
                throw new NotImplementedException();
            }
            else
   ...
   && myRenderParams.IsGlobalIlluminationEnabled)
  {
    myAccumFrames++;
        ...
        bool prepareFrameBuffers(Projection theProj)
        {
            ...
            if (myHasFboBlit
             && (myTransientDrawToFront
              || theProj == Projection.Projection_Stereo
              || aNbSamples != 0
              || toUseOit
              || aSizeX != aRendSize.x()))
            {
    ...
    }; OpenGl_FrameBuffer[] anImmFbosOit =
    {
      ...
      myMainSceneFbos[1].IsValid() ? myMainSceneFbos[1] : null
                ...
                toSwap = redrawImmediate(Projection.Projection_MonoLeftEye,
                                     aMainFbos[0],
                                     anImmFbos[0],
                                     anImmFbosOit[0],
                                     true) || toSwap;
        ...
        private bool redrawImmediate(Projection theProjection,
    ...
    new     Vector4( 1.0f,  1.0f, 1.0f, 0.0f),
     new    Vector4(-1.0f, -1.0f, 0.0f, 1.0f),
       new Vector4(-1.0f,  1.0f, 0.0f, 0.0f)
        ...
        private bool blitSubviews(Projection theProjection, OpenGl_FrameBuffer theDrawFbo)
        {
            OpenGl_Context aCtx = myWorkspace.GetGlContext();
            if (aCtx.arbFBOBlit == null)
            {
        ...
        private bool copyBackToFront()
        {
            ...
            OpenGl_Mat4 aProjectMat = new Graphic3d_Mat4();
        ...
        //! @param theOitAccumFbo [in] the framebuffer for accumulating color and coverage for OIT process.
        //! @param theToDrawImmediate [in] the flag indicates whether the rendering performs in immediate mode.
        public void renderScene(Projection theProjection,
                             OpenGl_FrameBuffer theReadDrawFbo,
                             OpenGl_FrameBuffer theOitAccumFbo,
                              bool theToDrawImmediate)
        {
        ...
        //! @param theOitAccumFbo [in] the framebuffer for accumulating color and coverage for OIT process.
        //! @param theToDrawImmediate [in] the flag indicates whether the rendering performs in immediate mode.
        void render(Projection theProjection,
        ...
        public override OpenGl_Layer[] Layers()
        {
        ...
        public override OpenGl_Layer Layer(Graphic3d_ZLayerId theLayerId)
        {
            OpenGl_Layer aLayer = null;
    ...
    {
        public static Graphic3d_Vec3 rgb(this OpenGl_Vec4 v)
        {
            return new OpenGl_Vec3(v.r(), v.g(), v.b());
        }
        public static OpenGl_Vec4 ToOpenGl_Vec4(this OpenTK.Mathematics.Vector4 v)
        {
            return new OpenGl_Vec4(v.X, v.Y, v.Z, v.W);
        }
