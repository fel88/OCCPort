...
namespace TKOpenGl
{
  ...
  "occNbSpecIBLLevels"      // OpenGl_OCCT_NB_SPEC_IBL_LEVELS
        ...
        public bool Initialize(OpenGl_Context theCtx, Graphic3d_ShaderObjectList theShaders)
        {
            ...
            int aShaderMask = 0;
            for (Graphic3d_ShaderObjectList.Iterator anIter = new Graphic3d_ShaderObjectList.Iterator(theShaders); anIter.More(); anIter.Next())
            {
            ...
            theCtx.core20fwd.glUseProgram(anOldProgram != null ? anOldProgram.ProgramId() : NO_PROGRAM);
            return true;
        }
