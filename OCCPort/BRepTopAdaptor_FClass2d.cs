...
//                        double TolVertex1 = 0., TolVertex = 0.;
...
//                        double anExpThick = Max(2. * Abs(square) / aPer, 1e-7);
//                        double aDefl = Max(FlecheU, FlecheV);
//                        double aDiscrDefl = Min(aDefl * 0.1, anExpThick * 10.);
