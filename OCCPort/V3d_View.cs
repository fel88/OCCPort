...
namespace OCCPort
{
  ...
  SetViewOrientationDefault();
        ...
        public bool IsInvalidatedImmediate() { return myIsInvalidatedImmediate; }

        protected bool myIsInvalidatedImmediate;

        //! Invalidates view content within immediate layer but does not redraw it.
        public void InvalidateImmediate() { myIsInvalidatedImmediate = true; }
